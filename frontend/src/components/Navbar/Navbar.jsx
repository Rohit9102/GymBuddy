...
import "./Navbar.css";
import { logoAsset } from "../../../src/assets/asset";
import { useContext, useState } from "react";
import { Link, useNavigate } from 'react-router-dom';
import { StoreContext } from "../../context/StoreContext";
    ...
    <div className="navbar text-center justify-center">
      ...
      <div className="navbar-right">
        ...
        {!token ? (
          ...
          <div className="navbar-profile">
            <img src={logoAsset.profile_icon} alt="profile icon" />

            <ul className="nav-profile-dropdown">
              <li onClick={() => navigate('/profile')}>
                <img src={logoAsset.profile_icon} alt="profile" />
                <p>Profile</p>
              </li>
              <li onClick={() => navigate('/myorders')}>
                <img src={logoAsset.bag_icon} alt="orders" />
                <p>Orders</p>
              </li>
              <hr />
              <li onClick={logout}>
                <img src={logoAsset.logout_icon} alt="logout" />
                <p>Logout</p>
              </li>
            </ul>
          </div>
